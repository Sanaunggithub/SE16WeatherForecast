...
Q_CONSTINIT const QMetaObject WeatherManager::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN14WeatherManagerE_t,
        ...
        // method 'currentWeatherReceived'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<const WeatherData &, std::false_type>,
        // method 'forecastReceived'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<const QVector<ForecastData> &, std::false_type>,
        // method 'errorOccurred'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<const QString &, std::false_type>,
        // method 'onCurrentWeatherReplyFinished'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'onForecastReplyFinished'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'onOneCallReplyFinished'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void WeatherManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (WeatherManager::*)(const WeatherData & );
            if (_q_method_type _q_method = &WeatherManager::currentWeatherReceived; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (WeatherManager::*)(const QVector<ForecastData> & );
            if (_q_method_type _q_method = &WeatherManager::forecastReceived; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (WeatherManager::*)(const QString & );
            if (_q_method_type _q_method = &WeatherManager::errorOccurred; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
